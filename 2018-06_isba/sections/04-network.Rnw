...
<<road_state_pred,fig.width=4.5,fig.height=2.3,out.width='0.4\\textwidth',results='asis',fig.align='center'>>=
p1
@
    ...
    \item update as vehicles traverse network using extended Kalman filter algorithm
        ...
        \end{itemize}
<<road_state_upd,fig.width=4.5,fig.height=2.3,out.width='0.4\\textwidth',results='asis',fig.align='center'>>=
p3
@
