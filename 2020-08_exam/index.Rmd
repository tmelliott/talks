...
***
## Particle filter and journey planning events

* Probability bus arrives before/after $t$
* Transfer probability<br><br>
* Directly from CDF
* Could be used in route selection criteria
    * "I want to travel from A to B, find me the fastest/soonest/less waiting route"

***
## Particle filter and journey planning events

[[ figure of arrival time CDFs for simple JP ]]
...
* Particle filter
    * flexible, multimodality, simple likelihood, estimation of road travel times
* Network state
    * updated in real-time from travel time estimates, extensible (forecasts)
* Predictions
