...
# x <- list(
#     `10` = system.time(do_solve(10)),
#     `500` = system.time(do_solve(500)),
#     `1000` = system.time(do_solve(1000)),
#     `1500` = system.time(do_solve(1500)),
#     `2000` = system.time(do_solve(2000))
# )

# plot(names(x), sapply(x, function(z) z[3]),
#     xlab = "M", ylab = "Time (seconds)", type = "b")
